...
function myBalance(req, res) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const user_balance = yield jsonwebtoken_1.default.verify((_a = req.cookies) === null || _a === void 0 ? void 0 : _a.nkoe, secret_1.SECRET_TOKEN);
            if (!user_balance) {
...
function cashInOut(req, res) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const cashout = yield jsonwebtoken_1.default.verify((_a = req.cookies) === null || _a === void 0 ? void 0 : _a.nkoe, secret_1.SECRET_TOKEN);
            if (!cashout) {
                res.status(401).send("unauthorized");
                return;
            }
            console.log(`I Got the token ${cashout}`);
            ...
            const newToken = yield jsonwebtoken_1.default.sign({
            ...
            }, secret_1.SECRET_TOKEN, { expiresIn: 86400 });
            res.status(201).cookie("nkoe", newToken).send(accountUserCashOut);
        }
        catch (error) {
...
function seeTransactions(req, res) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        const token = yield jsonwebtoken_1.default.verify((_a = req.cookies) === null || _a === void 0 ? void 0 : _a.nkoe, secret_1.SECRET_TOKEN);
        if (!token) {
            res.status(401).send("unauthorized");
            return;
        }
...
function loginUser(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            }, secret_1.SECRET_TOKEN, {
                expiresIn: 86400,
            });
            res.cookie("nkoe", token).send("logged!");
        }
        catch (error) {
